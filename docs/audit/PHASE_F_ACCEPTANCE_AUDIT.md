...
| Analytics (derived) | *None — computed at render* | `lib/analytics/*.ts` | Read-only computation | ❌ Derived only |
...
*Manual testing was not performed in this automated audit. These are predictions based on code analysis:*
