...
const de: Strings = {
  ...
  "reminder.enable.desc": "Erhalte eine sanfte Erinnerung zu deinen gewählten Zeiten.",
  "reminder.morning.label": "Morgendliche Erinnerung",
  "reminder.morning.desc": "Starte deinen Tag mit deinem Schlafzeitfenster.",
  "reminder.evening.label": "Abendliche Erinnerung",
  "reminder.evening.desc": "Entspanne dich und vervollständige dein Schlaftagebuch.",
  "reminder.weekly.label": "Wöchentliche Zusammenfassung",
  "reminder.weekly.desc": "Überprüfe deinen Fortschritt einmal pro Woche.",
  "reminder.save": "Einstellungen speichern",
  "reminder.saved": "Erinnerungseinstellungen gespeichert.",
  "reminder.error.emailEmpty": "Bitte gib eine E-Mail-Adresse ein.",
  "reminder.error.emailInvalid": "Bitte gib eine gültige E-Mail-Adresse ein.",
  "reminder.preview.title": "Vorschau",
  "reminder.preview.greeting": "Guten Abend 🌙",
  "reminder.preview.window": "Schlafzeitfenster für heute Abend",
  "reminder.preview.task": "Heutige CBT-I-Aufgabe",
  "reminder.preview.taskDone": "Schlaftagebuch ausfüllen",
  "reminder.preview.nextLesson": "Nächste Lektion",
  "reminder.preview.week2": "Woche 2",
  "reminder.preview.stimulus": "Stimuluskontrolle",
  "reminder.channel.email": "E-Mail",
  "reminder.weekday.Monday": "Montag",
  "reminder.weekday.Tuesday": "Dienstag",
  "reminder.weekday.Wednesday": "Mittwoch",
  "reminder.weekday.Thursday": "Donnerstag",
  "reminder.weekday.Friday": "Freitag",
  "reminder.weekday.Saturday": "Samstag",
  "reminder.weekday.Sunday": "Sonntag",
  "reminder.back": "Zurück zur Übersicht",
  "reminder.noindex": "Persönliche Einstellungsseite — nicht indexiert.",
  "reminder.timezone.label": "Zeitzone",
  "reminder.language.label": "Sprache",
  "reminder.language.en": "English",
  "reminder.language.es": "Español",
  "reminder.language.pt": "Português",
  "reminder.language.de": "Deutsch",
  "reminder.status.title": "Erinnerungsstatus",
  "reminder.status.active": "Aktiv",
  "reminder.status.inactive": "Nicht aktiv",
  "reminder.status.email": "E-Mail",
  "reminder.status.time": "Uhrzeit",
...
const dicts: Partial<Record<Lang, Strings>> = { en, zh, es, pt: en, de };
