...
describe("PauseConfirmDialog", () => {
  it("is not rendered when open is false", () => {
    render(
      <PauseConfirmDialog open={false} onOpenChange={() => {}} onConfirm={() => {}} />
    );
  ...
  it("opens correctly when open is true", () => {
    render(
      <PauseConfirmDialog open={true} onOpenChange={() => {}} onConfirm={() => {}} />
    );
  ...
  it("cancel does not pause — calls onOpenChange(false) only", () => {
    ...
    render(
      <PauseConfirmDialog open={true} onOpenChange={onOpenChange} onConfirm={onConfirm} />
    );
  ...
  it("Escape does nothing when dialog is closed", () => {
    const onOpenChange = vi.fn();
    render(
      <PauseConfirmDialog open={false} onOpenChange={onOpenChange} onConfirm={() => {}} />
    );
