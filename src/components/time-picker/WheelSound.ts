...
if (typeof window !== "undefined") {
  ...
  unlockEvents.forEach((e) => window.addEventListener(e, unlock, { once: true, passive: true }));
}

// The <audio> element already routes through the OS audio output, so system
// volume and the iOS / iPadOS Silent switch are honored natively. We never
// block playback ourselves; there is no in-page mute switch.
