...
const TIERS: CycleTier[] = [
  ...
  { cycles: 5, rank: 1, cardClass: "border-purple-400 bg-purple-500/15 shadow-purple-500/20", badge: "recommended", highlight: true },
  { cycles: 6, rank: 2, cardClass: "border-emerald-400 bg-emerald-500/15 shadow-emerald-500/20", badge: "recommended", highlight: true },
  { cycles: 7, rank: 3, cardClass: "border-amber-400 bg-amber-500/15 shadow-amber-500/20", badge: "recovery" },
];
            ...
            {results.map((r) => (
              ...
              >
                ...
                {r.badge && (
                  ...
                  >
                    {r.badge === "recommended" ? t("calc.badge.recommended") : t("calc.badge.recovery")}
                  </span>
                )}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">
                      {r.hours}{dict.common.hoursShort} · {r.cycles} {dict.common.cyclesWord}
                    </div>
                  </div>
                </div>
