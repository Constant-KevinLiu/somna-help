/**
 * Página de inicio en español (/es).
 *
 * Renderiza el mismo hero y secciones que la home inglesa, pero con textos
 * nativos en español tomados de src/locales/es/common.json.
 *
 * El resto de páginas (/es/diary, /es/calculator, etc.) siguen el mismo
 * patrón: una ruta bajo src/routes/es/ que reutiliza el componente de página
 * inglés pasándole el idioma "es".
 */
            ...
            <div className="relative flex h-56 w-56 items-center justify-center rounded-full bg-gradient-to-br from-primary/40 to-accent/40 animate-breathe md:h-72 md:w-72">
              <div className="flex h-40 w-40 items-center justify-center rounded-full glass-strong md:h-52 md:w-52">
                <div className="text-center">
                  ...
                  <div className="mt-2 font-display text-2xl text-foreground">entra · sale</div>
                </div>
              </div>
            </div>
          </div>
