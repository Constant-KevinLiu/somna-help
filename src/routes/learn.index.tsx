...
export const Route = createFileRoute("/learn/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A library of long-form CBT-I guides and short, evidence-based lessons to help you understand sleep — and yourself." },
      { property: "og:title", content: "Learn — CBT-I Guides & Quick Lessons | Somna" },
      { property: "og:description", content: "Evidence-based sleep education — long-form guides and quick lessons." },
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {CBTI_SLUGS.map((s) => (
              ...
              >
                ...
                <div className="font-display text-lg text-foreground group-hover:text-accent">{cbti.titles[s]}</div>
      ...
      <section className="px-5 pb-20">
        <div className="mx-auto max-w-5xl">
          <div className="mb-6 flex items-center gap-3">
            ...
            <h2 className="font-display text-2xl text-foreground">{dict.ui.hubQuickLessonsLabel}</h2>
          </div>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {LEARN_SLUGS.map((s) => (
              <Link
              ...
              >
                ...
                <div className="font-display text-lg text-foreground group-hover:text-accent">{dict.titles[s]}</div>
