/**
 * Página estática da Lição 8 da Semana 3 do Programa TCC-I em português
 * brasileiro (/pt/program/week-3/sleep-restriction-therapy).
 *
 ...
 * - Rota 1:1 alinhada à versão inglesa /program/week-3/sleep-restriction-therapy.
 *
...
export const Route = createFileRoute("/pt/program/week-3/sleep-restriction-therapy")({
  loader: async () => {
    const lesson = await loadLesson("week-3", "sleep-restriction-therapy");
  ...
  head: ({ loaderData }) => {
    ...
    return ptLessonHeadFromLocales(lesson, "week3.lesson8");
  },
  notFoundComponent: () => (
  ...
  component: PtLesson8Route,
});

function PtLesson8Route() {
