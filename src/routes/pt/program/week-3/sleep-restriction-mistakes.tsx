/**
 * Página estática da Lição 9 da Semana 3 do Programa TCC-I em português
 * brasileiro (/pt/program/week-3/sleep-restriction-mistakes).
 *
 ...
 *   src/locales/pt/week-3.json (sem tradução do inglês).
 * - hreflang bidirecional (en / es / pt + x-default) e canonical próprios.
 * - Rota 1:1 alinhada à versão inglesa /program/week-3/sleep-restriction-mistakes.
 *
...
export const Route = createFileRoute("/pt/program/week-3/sleep-restriction-mistakes")({
  loader: async () => {
    const lesson = await loadLesson("week-3", "sleep-restriction-mistakes");
  ...
  head: ({ loaderData }) => {
    ...
    return ptLessonHeadFromLocales(lesson, "week3.lesson9");
  },
  notFoundComponent: () => (
  ...
  component: PtLesson9Route,
});

function PtLesson9Route() {
