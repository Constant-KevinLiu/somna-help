/**
 * Página estática da Lição 7 da Semana 3 do Programa TCC-I em português
 * brasileiro (/pt/program/week-3/what-is-sleep-efficiency).
 *
 ...
 * - Rota 1:1 alinhada à versão inglesa /program/week-3/what-is-sleep-efficiency.
 *
...
export const Route = createFileRoute("/pt/program/week-3/what-is-sleep-efficiency")({
  loader: async () => {
    const lesson = await loadLesson("week-3", "what-is-sleep-efficiency");
  ...
  head: ({ loaderData }) => {
    ...
    return ptLessonHeadFromLocales(lesson, "week3.lesson7");
  },
  notFoundComponent: () => (
  ...
  component: PtLesson7Route,
});

function PtLesson7Route() {
