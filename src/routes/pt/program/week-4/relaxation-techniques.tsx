/**
 * Página estática da Lição 11 da Semana 4 do Programa TCC-I em português
 * brasileiro (/pt/program/week-4/relaxation-techniques).
 *
 ...
 * - Rota 1:1 alinhada à versão inglesa /program/week-4/relaxation-techniques.
 *
...
export const Route = createFileRoute("/pt/program/week-4/relaxation-techniques")({
  loader: async () => {
    const lesson = await loadLesson("week-4", "relaxation-techniques");
  ...
  head: ({ loaderData }) => {
    ...
    return ptLessonHeadFromLocales(lesson, "week4.lesson11");
  },
  notFoundComponent: () => (
  ...
  component: PtLesson11Route,
});

function PtLesson11Route() {
