/**
 * Página estática da Lição 12 da Semana 4 do Programa TCC-I em português
 * brasileiro (/pt/program/week-4/breathing-exercises-for-sleep).
 *
 ...
 *   src/locales/pt/week-4.json (sem tradução do inglês).
 * - hreflang bidirecional (en / es / pt + x-default) e canonical próprios.
 * - Rota 1:1 alinhada à versão inglesa /program/week-4/breathing-exercises-for-sleep.
 *
...
export const Route = createFileRoute("/pt/program/week-4/breathing-exercises-for-sleep")({
  loader: async () => {
    const lesson = await loadLesson("week-4", "breathing-exercises-for-sleep");
  ...
  head: ({ loaderData }) => {
    ...
    return ptLessonHeadFromLocales(lesson, "week4.lesson12");
  },
  notFoundComponent: () => (
  ...
  component: PtLesson12Route,
});

function PtLesson12Route() {
