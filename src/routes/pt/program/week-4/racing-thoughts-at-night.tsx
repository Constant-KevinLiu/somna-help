/**
 * Página estática da Lição 10 da Semana 4 do Programa TCC-I em português
 * brasileiro (/pt/program/week-4/racing-thoughts-at-night).
 *
 ...
 * - Rota 1:1 alinhada à versão inglesa /program/week-4/racing-thoughts-at-night.
 *
...
export const Route = createFileRoute("/pt/program/week-4/racing-thoughts-at-night")({
  loader: async () => {
    const lesson = await loadLesson("week-4", "racing-thoughts-at-night");
  ...
  head: ({ loaderData }) => {
    ...
    return ptLessonHeadFromLocales(lesson, "week4.lesson10");
  },
  notFoundComponent: () => (
  ...
  component: PtLesson10Route,
});

function PtLesson10Route() {
