/**
 * Página estática da Lição 16 da Semana 6 do Programa TCC-I em português
 * brasileiro (/pt/program/week-6/preventing-relapse).
 *
 ...
 * - Rota 1:1 alinhada à versão inglesa /program/week-6/preventing-relapse.
 *
...
export const Route = createFileRoute("/pt/program/week-6/preventing-relapse")({
  loader: async () => {
    const lesson = await loadLesson("week-6", "preventing-relapse");
  ...
  head: ({ loaderData }) => {
    ...
    return ptLessonHeadFromLocales(lesson, "week6.lesson16");
  },
  notFoundComponent: () => (
  ...
  component: PtLesson16Route,
});

function PtLesson16Route() {
