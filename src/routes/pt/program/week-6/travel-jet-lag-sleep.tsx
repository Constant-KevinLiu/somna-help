/**
 * Página estática da Lição 17 da Semana 6 do Programa TCC-I em português
 * brasileiro (/pt/program/week-6/travel-jet-lag-sleep).
 *
 ...
 * - Rota 1:1 alinhada à versão inglesa /program/week-6/travel-jet-lag-sleep.
 *
...
export const Route = createFileRoute("/pt/program/week-6/travel-jet-lag-sleep")({
  loader: async () => {
    const lesson = await loadLesson("week-6", "travel-jet-lag-sleep");
  ...
  head: ({ loaderData }) => {
    ...
    return ptLessonHeadFromLocales(lesson, "week6.lesson17");
  },
  notFoundComponent: () => (
  ...
  component: PtLesson17Route,
});

function PtLesson17Route() {
