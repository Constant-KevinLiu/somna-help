/**
 * Página estática da Lição 15 da Semana 5 do Programa TCC-I em português
 * brasileiro (/pt/program/week-5/realistic-sleep-expectations).
 *
 ...
 * - Rota 1:1 alinhada à versão inglesa /program/week-5/realistic-sleep-expectations.
 *
...
export const Route = createFileRoute("/pt/program/week-5/realistic-sleep-expectations")({
  loader: async () => {
    const lesson = await loadLesson("week-5", "realistic-sleep-expectations");
  ...
  head: ({ loaderData }) => {
    ...
    return ptLessonHeadFromLocales(lesson, "week5.lesson15");
  },
  notFoundComponent: () => (
