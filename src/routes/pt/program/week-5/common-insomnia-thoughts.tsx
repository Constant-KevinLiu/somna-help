/**
 * Página estática da Lição 13 da Semana 5 do Programa TCC-I em português
 * brasileiro (/pt/program/week-5/common-insomnia-thoughts).
 *
 ...
 * - Rota 1:1 alinhada à versão inglesa /program/week-5/common-insomnia-thoughts.
 *
...
export const Route = createFileRoute("/pt/program/week-5/common-insomnia-thoughts")({
  loader: async () => {
    const lesson = await loadLesson("week-5", "common-insomnia-thoughts");
  ...
  head: ({ loaderData }) => {
    ...
    return ptLessonHeadFromLocales(lesson, "week5.lesson13");
  },
  notFoundComponent: () => (
  ...
  component: PtLesson13Route,
});

function PtLesson13Route() {
