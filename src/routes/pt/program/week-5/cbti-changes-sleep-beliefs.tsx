/**
 * Página estática da Lição 14 da Semana 5 do Programa TCC-I em português
 * brasileiro (/pt/program/week-5/cbti-changes-sleep-beliefs).
 *
 ...
 *   src/locales/pt/week-5.json (sem tradução do inglês).
 * - hreflang bidirecional (en / es / pt + x-default) e canonical próprios.
 * - Rota 1:1 alinhada à versão inglesa /program/week-5/cbti-changes-sleep-beliefs.
 *
...
export const Route = createFileRoute("/pt/program/week-5/cbti-changes-sleep-beliefs")({
  loader: async () => {
    const lesson = await loadLesson("week-5", "cbti-changes-sleep-beliefs");
  ...
  head: ({ loaderData }) => {
    ...
    return ptLessonHeadFromLocales(lesson, "week5.lesson14");
  },
  notFoundComponent: () => (
  ...
  component: PtLesson14Route,
});

function PtLesson14Route() {
