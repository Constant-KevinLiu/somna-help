/**
 * Strona główna w języku polskim (/pl).
 *
 * Renderuje hero oraz sekcje inspirowane stroną główną, ale z tekstami
 * natywnie polskimi z src/locales/pl/common.json.
 */
...
export const Route = createFileRoute("/pl/")({
  head: () => {
    const t = loadPlDict();
    const title = getPlString(t, "seo.home.title");
    const description = getPlString(t, "seo.home.description");
    return {
      meta: [
        { title },
        { name: "description", content: description },
        { property: "og:title", content: getPlString(t, "seo.home.ogTitle") },
        { property: "og:description", content: getPlString(t, "seo.home.ogDescription") },
        { property: "og:locale", content: "pl_PL" },
        { property: "og:type", content: "website" },
      ],
      links: hreflangLinks("/pl"),
    };
  },
  component: PlHome,
});
            ...
            <div className="relative flex h-56 w-56 items-center justify-center rounded-full bg-gradient-to-br from-primary/40 to-accent/40 animate-breathe md:h-72 md:w-72">
              <div className="flex h-40 w-40 items-center justify-center rounded-full glass-strong md:h-52 md:w-52">
                <div className="text-center">
                  ...
                  <div className="mt-2 font-display text-2xl text-foreground">wdech · wydech</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="px-5 py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {[
              { t: t["features.1.t"], d: t["features.1.d"], to: `${prefix}/program` },
              { t: t["features.2.t"], d: t["features.2.d"], to: `${prefix}/calculator` },
              { t: t["features.3.t"], d: t["features.3.d"], to: `${prefix}/relax` },
            ].map((f, i) => (
              <SafeLink
                key={i}
                to={f.to}
