...
export const Route = createFileRoute("/pl/program/week-3/what-is-sleep-efficiency")({
  loader: async () => {
    const lesson = await loadLesson("week-3", "what-is-sleep-efficiency", "pl");
  ...
  head: ({ loaderData }) => {
    ...
    return plLessonHeadFromLocales(lesson, "week3.lesson7");
  },
  notFoundComponent: () => (
  ...
  component: PlLesson7Route,
});

function PlLesson7Route() {
  const { lesson } = Route.useLoaderData();
  if (typeof document !== "undefined") {
    const title = plLessonTitleFromLocales("week3.lesson7");
