...
const en: LearnDict = {
  ...
  lessons: {
    "what-is-cbti": {
      ...
      subtitle: "Cognitive Behavioral Therapy for Insomnia is not a sleeping pill — it's a structured way to retrain how your brain relates to sleep.",
      readingTime: "5",
      keyTakeaways: [
      ...
      relatedTool: { to: "/calculator", label: "Sleep Cycle Calculator", desc: "Plan around natural 90-minute cycles." },
      faqs: [
        { q: "Is CBT-I a type of medication?", a: "No. CBT-I is a behavioral and cognitive program. It uses structured techniques, not drugs, to address the root causes of insomnia." },
        { q: "How long does CBT-I take to work?", a: "Most people notice some change within 1–2 weeks and meaningful improvement within 4–8 weeks of consistent practice." },
        { q: "Is CBT-I better than sleeping pills?", a: "For chronic insomnia, yes — in long-term follow-up. Pills can help short-term but the gains rarely persist after stopping." },
        { q: "Do I need a therapist for CBT-I?", a: "A trained clinician produces the strongest results, but self-guided and digital CBT-I programs are also evidence-based and effective." },
        { q: "Will CBT-I help if I've had insomnia for years?", a: "Yes. Even long-standing insomnia responds well, because CBT-I targets the patterns currently maintaining it, not just the original trigger." },
        { q: "Are there side effects?", a: "The main 'side effect' is temporary tiredness during sleep restriction in week 1–2. There are no medication-related risks." },
        { q: "Can I do CBT-I while taking sleep medication?", a: "Often yes, with clinician guidance. Many people gradually taper medication during or after CBT-I." },
      ],
    ...
    "90-minute-sleep-cycle": {
      ...
      subtitle: "Sleep doesn't happen in one long block — it moves through repeating cycles, each shaping how you feel in the morning.",
      readingTime: "5",
      keyTakeaways: [
      ...
      relatedTool: { to: "/calculator", label: "Sleep Cycle Calculator", desc: "Plan bedtime around full cycles." },
      faqs: [
        { q: "Is every sleep cycle exactly 90 minutes?", a: "No — 90 minutes is an average. Cycles range roughly 70–120 minutes and shift across the night and between people." },
        { q: "How many cycles should I aim for?", a: "Most adults feel best with 5–6 cycles per night, which is about 7.5–9 hours of sleep." },
        { q: "Why do I sometimes wake up groggy even after enough sleep?", a: "You may have been woken in deep sleep. Adjusting bedtime by 15–30 minutes can land your wake time more gently." },
        { q: "Is deep sleep more important than REM?", a: "Both matter. Deep sleep supports physical recovery; REM supports memory and emotional regulation. A healthy night includes both." },
        { q: "Can I track my sleep cycles?", a: "Consumer wearables estimate stages but aren't medically precise. Patterns over weeks are more meaningful than any single night." },
        { q: "Why do cycles change across the night?", a: "Early cycles contain more deep sleep; later cycles contain more REM. Both halves of the night matter." },
        { q: "Does napping use sleep cycles too?", a: "Yes. A 90-minute nap can include a full cycle, while a 20-minute nap stays in lighter stages and avoids grogginess." },
      ],
    ...
    "4-7-8-breathing": {
      ...
      subtitle: "A simple breathing pattern that gently lowers physiological arousal — a practical pre-sleep ritual backed by basic physiology.",
      readingTime: "5",
      keyTakeaways: [
      ...
      relatedGuide: { slug: "how-to-fall-asleep-fast" },
      relatedTool: { to: "/relax", label: "Guided 4-7-8 Session", desc: "Practice with a calm visual cue." },
      faqs: [
        { q: "Does 4-7-8 breathing put you to sleep?", a: "Not directly. It reduces arousal and supports falling asleep, but it is not a sedative." },
        { q: "How many cycles should I do?", a: "Start with 4 cycles. Some practitioners build up over weeks. More isn't always better." },
        { q: "Is it safe for everyone?", a: "It is generally considered safe for healthy adults. If you have lung conditions, low blood pressure, or feel lightheaded, breathe naturally instead." },
        { q: "Can children practice it?", a: "A simpler version (shorter holds) can work for older children, but check with a pediatrician first." },
        { q: "Why exhale longer than inhale?", a: "Long exhales activate the parasympathetic 'rest and digest' branch of the nervous system." },
        { q: "What if counting makes me more anxious?", a: "Skip the count. Just breathe slowly through the nose with a long, soft exhale. The pattern matters more than the numbers." },
        { q: "How often should I practice?", a: "Daily is ideal — even outside of bedtime — to train the response. Most people notice benefits within 1–2 weeks." },
      ],
    ...
    "racing-thoughts-at-night": {
      ...
      subtitle: "Racing thoughts at bedtime aren't a character flaw — they're a predictable feature of an aroused nervous system. CBT-I has practical tools for them.",
      readingTime: "5",
      keyTakeaways: [
      ...
      relatedTool: { to: "/relax", label: "Wind-down Breathing", desc: "Quiet the body to quiet the mind." },
      faqs: [
        { q: "Why do racing thoughts always hit at bedtime?", a: "Without daytime distractions, inner thoughts have nothing to compete with. A tired prefrontal cortex also makes worries feel more urgent." },
        { q: "Should I try to push thoughts away?", a: "No — that usually amplifies them. The goal is to notice thoughts and let them pass, like clouds moving across the sky." },
        { q: "Is journaling really helpful?", a: "Yes, especially when done earlier in the evening. A 'worry window' externalizes concerns so they don't surge in bed." },
        { q: "Are racing thoughts the same as anxiety?", a: "They overlap heavily. If thoughts come with persistent worry, low mood, or panic, consider speaking with a clinician." },
        { q: "Can meditation help?", a: "For many people, yes — especially mindfulness-based approaches that focus on noticing thoughts without engaging." },
        { q: "What about listening to a podcast in bed?", a: "Mixed evidence. Light audio works for some people, while engaging content keeps the brain too active." },
        { q: "Do racing thoughts mean I have insomnia?", a: "Not alone. Insomnia is defined by trouble sleeping that occurs at least 3 nights a week for 3+ months and impacts daytime functioning." },
      ],
    ...
    "circadian-rhythm": {
      ...
      subtitle: "Your body has an internal 24-hour clock. Light and caffeine are two of the strongest signals shaping when sleep comes easily.",
      readingTime: "5",
      keyTakeaways: [
      ...
      relatedGuide: { slug: "how-to-fall-asleep-fast" },
      relatedTool: { to: "/bedtime-calculator", label: "Bedtime Calculator", desc: "Find the best time to go to bed." },
      faqs: [
        { q: "How long does caffeine stay in your system?", a: "Caffeine has a half-life of about 5 hours, so half of a 2 PM coffee is still active at 7 PM and a quarter is still active at midnight." },
        { q: "Does morning light really matter?", a: "Yes — it's one of the strongest signals to anchor your circadian rhythm. Even 5–10 minutes outdoors helps." },
        { q: "Are blue-light glasses worth it?", a: "Lowering overall light intensity in the evening tends to matter more than filtering blue light specifically." },
        { q: "Is decaf truly caffeine-free?", a: "Not entirely — decaf still contains a small amount of caffeine, usually 2–15 mg per cup." },
        { q: "What if I work night shifts?", a: "Aim for strategic bright-light exposure during your 'day' and darkness during your 'night.' Shift work disrupts circadian rhythm and benefits from a tailored plan." },
        { q: "Does alcohol affect my body clock?", a: "Alcohol fragments sleep and can shift sleep architecture even when it helps you fall asleep faster." },
        { q: "How quickly can I reset my rhythm?", a: "Most adults shift by about 1 hour per day with consistent light, meal, and wake-time cues." },
      ],
      nextLesson: "stimulus-control",
    },
    "stimulus-control": {
      ...
      subtitle: "Stimulus control retrains the simple, learned link between bed and sleep — and it's one of the most powerful tools in CBT-I.",
      readingTime: "5",
      keyTakeaways: [
      ...
      cta: { label: "Read the Complete CBT-I Guide", to: "/cbt-i-guide" },
      relatedGuide: { slug: "cbt-i-guide" },
      relatedTool: { to: "/calculator", label: "Sleep Cycle Calculator", desc: "Match bedtime to natural cycles." },
      faqs: [
        { q: "What is stimulus control in CBT-I?", a: "Stimulus control is the practice of using your bed only for sleep, leaving the bed if you're not sleeping, and keeping a consistent wake time — so the bed becomes a cue for sleep again." },
        { q: "How long until stimulus control works?", a: "Many people see improvement within 1–3 weeks of consistent practice." },
        { q: "Is the 20-minute rule strict?", a: "It's a guideline. Don't watch the clock — estimate. If you feel clearly awake and frustrated, leave the bed." },
        { q: "What should I do when I leave the bed?", a: "Something calm and low-light: read a gentle book, do slow stretches, sit quietly. Avoid screens, work, and anything stimulating." },
        { q: "Does stimulus control work for middle-of-the-night awakenings?", a: "Yes — the same 20-minute rule applies. If you wake and can't fall back asleep, leave the bed and return only when sleepy." },
        { q: "What if leaving the bed wakes me up more?", a: "Keep lights dim, activity calm, and your body relaxed. The goal isn't full alertness — it's allowing sleepiness to return naturally." },
        { q: "Can I do stimulus control without other CBT-I tools?", a: "It can be effective on its own, but combining it with sleep restriction and consistent wake times produces the strongest results." },
      ],
...
const zh: LearnDict = {
  ...
  lessons: {
    "what-is-cbti": {
      meta: { title: "CBT-I 究竟是什么? | Somna", desc: "对失眠认知行为治疗(CBT-I)的入门解读,以及为何它被视为最有效的长期失眠疗法。" },
      eyebrow: "微课",
      title: "CBT-I 究竟是什么?",
      ...
      sections: [
        { heading: "CBT-I 是什么意思?", paras: [
          "CBT-I 是\"失眠认知行为治疗\"的英文缩写。它是一套结构化、限定时长的方案,针对维持失眠的具体想法和行为。",
          "与安眠药不同,CBT-I 不会让你昏沉,而是温柔地引导身体和大脑恢复自然的睡眠节律,没有副作用。",
        ]},
        { heading: "睡眠问题是如何被\"学会\"的", paras: [
          "偶尔几个不眠之夜很正常。但当大脑开始把床与挫败感或清醒联系起来,问题就会慢性化。",
          "几周或几个月后,这种联系会越来越牢固。神经系统学到:\"上床 = 保持警觉。\"CBT-I 之所以有效,就是因为它直接处理这种学习。",
        ]},
        { heading: "五大核心组成", paras: [
          "CBT-I 综合了五种循证工具:睡眠限制(压缩在床上的时间以恢复睡眠驱力)、刺激控制(重新把床和睡眠联系起来)、认知重构(松动焦虑想法)、睡眠卫生(微小的环境调整)和放松训练。",
          "组合使用,它们能从多个角度同时打破失眠的循环。",
        ]},
        { heading: "为什么 CBT-I 长期有效", paras: [
          "药物只能在服用期间掩盖症状。CBT-I 改变的是底层模式,因此停止后效果依然存在。",
          "随访研究显示,效果可维持 1 到 3 年,这在失眠疗法中相当少见。",
        ]},
        { heading: "谁适合 CBT-I?", paras: [
          "绝大多数慢性失眠的成年人都能从中受益,包括老年人和多年困扰者。CBT-I 也适合与焦虑或抑郁治疗同步进行。",
          "如果你有未治疗的睡眠呼吸暂停、不宁腿等问题,请先咨询医生,以便安全地定制 CBT-I 方案。",
        ]},
      ],
      scienceNote: "包括美国睡眠医学会(AASM)与美国内科医师学会(ACP)在内的主要睡眠医学组织,都把 CBT-I 列为成年慢性失眠的一线疗法。",
      practicalTip: "今晚开始,床只用于睡眠与亲密——不刷手机、不工作、不焦虑。这条简单的规则正是\"刺激控制\"的核心。",
      cta: { label: "阅读完整的 CBT-I 指南", to: "/cbt-i-guide" },
      relatedGuide: { slug: "cbt-i-guide" },
      relatedTool: { to: "/calculator", label: "睡眠周期计算器", desc: "围绕 90 分钟自然周期来安排作息。" },
      faqs: [
        { q: "CBT-I 是一种药物吗?", a: "不是。CBT-I 是一套行为与认知方案,通过结构化技巧而非药物,处理失眠的根本原因。" },
        { q: "CBT-I 多久能见效?", a: "大多数人在 1–2 周内会感到一些变化,持续练习 4–8 周后可见明显改善。" },
        { q: "CBT-I 比安眠药更好吗?", a: "对慢性失眠而言,长期随访来看是的。药物可短期帮助,但停药后效果通常无法保持。" },
        { q: "必须找治疗师吗?", a: "经过 CBT-I 培训的临床医生效果最佳,但自助式与数字 CBT-I 项目同样具有科学依据,也很有效。" },
        { q: "失眠很多年了还有效吗?", a: "有效。因为 CBT-I 针对的是当前仍在维持失眠的模式,而不仅是最初的诱因。" },
        { q: "有副作用吗?", a: "主要的'副作用'是在睡眠限制的第 1–2 周可能短暂感到疲劳,没有药物相关的风险。" },
        { q: "可以同时服用安眠药吗?", a: "通常可以,在医生指导下进行。许多人会在 CBT-I 期间或之后逐步减药。" },
      ],
      nextLesson: "stimulus-control",
    },
    "90-minute-sleep-cycle": {
      meta: { title: "90 分钟睡眠周期 | Somna", desc: "了解睡眠周期如何运作,以及在合适的时间醒来为何能让你更有精神。" },
      eyebrow: "微课",
      title: "90 分钟睡眠周期",
      subtitle: "睡眠并不是一整段同质的过程,而是由反复出现的周期组成,每个周期都会影响你的清晨感受。",
      readingTime: "5",
      keyTakeaways: [
    ...
    "4-7-8-breathing": {
      ...
      sections: [
        ...
        { heading: "融入夜间作息", paras: [
          "把它和另一个动作搭配——调暗灯光、洗脸、上床——让它成为'今天结束'的自动信号。",
          "大多数人在持续练习 1–2 周后,会感到最明显的好处。",
        ]},
      ],
      scienceNote: "节律性缓慢呼吸已被研究证实可降低健康成年人的心率、血压和自我报告的压力水平。",
      practicalTip: "今晚熄灯前尝试 2–4 个 4-7-8 循环。你不是在追求入睡,而是在向身体发出'安全'的信号。",
      cta: { label: "如何更快入睡", to: "/how-to-fall-asleep-fast" },
      relatedGuide: { slug: "how-to-fall-asleep-fast" },
      relatedTool: { to: "/relax", label: "引导式 4-7-8 练习", desc: "跟随平静的视觉提示进行练习。" },
      faqs: [
        { q: "4-7-8 呼吸能直接让人入睡吗?", a: "不能。它能降低唤醒水平,辅助入睡,但本身不是镇静剂。" },
        { q: "应该做几个循环?", a: "从 4 个开始。一些练习者会在几周内逐步增加,但更多并不一定更好。" },
        { q: "所有人都安全吗?", a: "对健康成年人通常安全。如有肺部疾病、低血压或感到头晕,请改用自然呼吸。" },
        { q: "儿童可以练习吗?", a: "可适当缩短屏息时间用于较大儿童,但请先咨询儿科医生。" },
        { q: "为什么呼气比吸气长?", a: "长呼气会激活副交感神经系统,即所谓的'休息与消化'模式。" },
        { q: "数数让我更焦虑怎么办?", a: "可以不数数,只用鼻缓慢吸气,然后柔长地呼气。模式比数字更重要。" },
        { q: "需要多久练习一次?", a: "理想情况是每天练习——不限于睡前。大多数人 1–2 周内能看到效果。" },
      ],
      nextLesson: "racing-thoughts-at-night",
    },
    "racing-thoughts-at-night": {
      meta: { title: "当思绪无法安静 | Somna", desc: "了解为什么思绪在夜里更喧闹,以及 CBT-I 如何应对赛跑的想法。" },
      eyebrow: "微课",
      title: "当思绪无法安静",
      subtitle: "睡前思绪奔涌不是性格缺陷,而是神经系统被过度激活后的可预期表现。CBT-I 提供了实用工具。",
      readingTime: "5",
      keyTakeaways: [
        "夜间思绪奔涌很常见,并非异常。",
        "身体与心理的过度唤醒都起重要作用。",
      ...
      sections: [
        ...
        { heading: "为什么'不要想'没用", paras: [
          "告诉自己'不要想',通常会让想法更响,这就是'白熊效应':越想压住,它越冒头。",
          "CBT-I 改变目标——不是停止想法,而是学习让它们经过,不去回应。",
        ]},
        { heading: "有用的 CBT-I 策略", paras: [
          "设一个白天的'担忧时段':傍晚花 10 分钟写下担心和下一步行动,时间到了就合上本子。",
          "如果在床上空转了约 20 分钟,起来,坐到光线柔和的地方,做点平静的事,直到再次困倦才回到床。这是 CBT-I 工具中最有力的'刺激控制'。",
        ]},
        { heading: "何时寻求专业帮助", paras: [
          "如果思绪奔涌伴随持续的情绪低落、白天惊恐或显著影响生活,请联系专业人士。",
          "焦虑与失眠常常同行,协同治疗往往效果更佳。",
        ]},
      ],
      scienceNote: "现代研究越来越把失眠理解为一种'高唤醒'障碍——同时涉及认知(心理)与生理(身体)的激活。",
      practicalTip: "今晚刷牙前先把明天的任务清单写下来。把负担'外化',就告诉大脑不必在床上反复演练。",
      cta: { label: "阅读《睡眠焦虑》指南", to: "/sleep-anxiety" },
      relatedGuide: { slug: "sleep-anxiety" },
      relatedTool: { to: "/relax", label: "睡前呼吸", desc: "先让身体平静,心也会随之平静。" },
      faqs: [
        { q: "为什么思绪总在临睡前涌现?", a: "白天的干扰消失,内在思绪无人竞争。疲惫的'冷静规划区'又让担忧显得更紧迫。" },
        { q: "应该努力把想法推开吗?", a: "不。这通常会放大它们。目标是注意到想法,让它们像云一样飘过。" },
        { q: "写日记真的有帮助吗?", a: "有,尤其是在傍晚提早进行。'担忧时段'让担心外化,不在床上爆发。" },
        { q: "思绪奔涌等于焦虑吗?", a: "高度重叠。如伴随持续担忧、低落或惊恐,请考虑寻求专业帮助。" },
        { q: "冥想有帮助吗?", a: "对许多人有帮助,尤其是关注'觉察想法但不参与'的正念取向。" },
        { q: "睡前听播客行吗?", a: "证据不一。轻量音频对部分人有用,内容过强则可能让大脑更活跃。" },
        { q: "思绪奔涌就等于失眠吗?", a: "不必然。失眠的临床定义是每周至少 3 晚、持续 3 个月以上的睡眠困难并影响白天功能。" },
      ],
      nextLesson: "circadian-rhythm",
    },
    "circadian-rhythm": {
      meta: { title: "光、咖啡因与你的生物钟 | Somna", desc: "了解光照与咖啡因如何影响生物钟与入睡时间。" },
      eyebrow: "微课",
      title: "光、咖啡因与你的生物钟",
      ...
      sections: [
        ...
        { heading: "咖啡因如何影响睡眠", paras: [
          "咖啡因阻断腺苷——一种白天积累'睡眠压力'的分子。它的半衰期约 5 小时,所以下午 2 点的咖啡到睡前仍在体内活跃。",
          "即便能入睡,夜间咖啡因也可能减少深睡,让你在不自知的情况下醒来仍感疲倦。",
        ]},
        { heading: "建立更好的时机习惯", paras: [
          "目标:固定起床时间、每日晨间光照、下午稍早的咖啡因截止时间。三个小改变可能改变整周感觉。",
          "持续比完美更重要。可持续的小调整往往胜过激进的大改造。",
        ]},
      ],
      scienceNote: "光是塑造生物钟的最强信号之一——尤其是早晨的明亮光照与傍晚的低光环境。",
      practicalTip: "起床一小时内到户外晒光,即使只是 5–10 分钟。再尝试为期两周的'下午 2 点之后不喝咖啡',看夜晚是否改善。",
      cta: { label: "使用最佳入睡时间计算器", to: "/bedtime-calculator" },
      relatedGuide: { slug: "how-to-fall-asleep-fast" },
      relatedTool: { to: "/bedtime-calculator", label: "最佳入睡时间计算器", desc: "找到最适合上床的时间。" },
      faqs: [
        { q: "咖啡因在体内停留多久?", a: "半衰期约 5 小时:下午 2 点的咖啡,到晚上 7 点仍剩一半,午夜还有四分之一。" },
        { q: "晨间光照真的重要吗?", a: "重要。它是稳定生物钟最强的信号之一,哪怕只是 5–10 分钟户外光。" },
        { q: "防蓝光眼镜值得买吗?", a: "傍晚降低整体光强,比单独过滤蓝光更重要。" },
        { q: "脱因咖啡完全没有咖啡因吗?", a: "不是。脱因咖啡每杯通常仍含 2–15 毫克咖啡因。" },
        { q: "上夜班怎么办?", a: "在'白天'增加亮光暴露,在'夜晚'保持黑暗。轮班工作会扰乱生物钟,需要定制化方案。" },
        { q: "酒精会影响生物钟吗?", a: "酒精会打碎睡眠结构,即便让你更快入睡,也会改变睡眠的整体质量。" },
        { q: "多久能调整生物钟?", a: "在稳定的光照、用餐与起床信号下,大多数成年人每天可调整约 1 小时。" },
      ],
      nextLesson: "stimulus-control",
    },
    "stimulus-control": {
      meta: { title: "通俗易懂的刺激控制法 | Somna", desc: "学习 CBT-I 中最有效的策略之一,重建床与睡眠之间的健康联系。" },
      eyebrow: "微课",
      title: "通俗易懂的刺激控制法",
      ...
      practicalTip: "今晚就把屏幕、工作材料和笔记本电脑搬出卧室。哪怕只是小小的物理改变,也能重新塑造信号。",
      cta: { label: "阅读完整的 CBT-I 指南", to: "/cbt-i-guide" },
      relatedGuide: { slug: "cbt-i-guide" },
      relatedTool: { to: "/calculator", label: "睡眠周期计算器", desc: "让上床时间匹配自然周期。" },
      faqs: [
        { q: "CBT-I 中的刺激控制是什么?", a: "就是只把床用于睡眠;睡不着就离开床;保持稳定的起床时间——让床再次成为睡眠的信号。" },
        { q: "多久能看到效果?", a: "持续练习 1–3 周内,大多数人会有所改善。" },
        { q: "20 分钟法则要严格遵守吗?", a: "这是参考。不要盯时钟,估算就好。如果明显清醒且烦躁,就离开床。" },
        { q: "离开床后该做什么?", a: "做平静、低刺激的事:读温和的书、慢拉伸、安静坐着。避免屏幕、工作或刺激性内容。" },
        { q: "对半夜醒来也有效吗?", a: "有效。半夜醒来如约 20 分钟无法再入睡,同样离开床,困了再回。" },
        { q: "离开床反而更清醒怎么办?", a: "保持灯光昏暗、动作轻缓、身体放松。目标不是完全清醒,而是让困意自然回来。" },
...
const esSummaries: Record<LearnSlug, string> = {
  ...
  "racing-thoughts-at-night": "Por qué los pensamientos se hacen ruidosos de noche — y qué hace la TCC-I.",
...
const es: LearnDict = {
  ...
  lessons: {
    "what-is-cbti": {
      meta: { title: "¿Qué es realmente la TCC-I? | Somna", desc: "Una explicación accesible de la Terapia Cognitivo-Conductual para el Insomnio (TCC-I) y por qué se considera el tratamiento más efectivo a largo plazo." },
      eyebrow: "MICROLECCIÓN",
      title: "¿Qué es realmente la TCC-I?",
      subtitle: "La Terapia Cognitivo-Conductual para el Insomnio no es una pastilla — es una forma estructurada de reentrenar la relación de tu cerebro con el sueño.",
      readingTime: "5",
      keyTakeaways: [
      ...
      sections: [
        { heading: "¿Qué significa TCC-I?", paras: [
        ...
        { heading: "Cómo se aprende el problema del sueño", paras: [
        ...
        { heading: "Los cinco componentes centrales", paras: [
        ...
        { heading: "Por qué funciona a largo plazo", paras: [
        ...
        { heading: "¿A quién puede ayudar?", paras: [
      ...
      scienceNote: "Las principales organizaciones de medicina del sueño — incluidas AASM y ACP — recomiendan la TCC-I como tratamiento de primera línea para el insomnio crónico en adultos.",
      practicalTip: "Esta noche, usa la cama solo para dormir e intimidad — sin scrollear, sin trabajar, sin rumiar. Esta regla es el corazón del control de estímulos.",
      cta: { label: "Lee la guía completa de TCC-I", to: "/cbt-i-guide" },
      relatedGuide: { slug: "cbt-i-guide" },
      relatedTool: { to: "/calculator", label: "Calculadora de ciclos", desc: "Planifica con ciclos naturales de 90 minutos." },
      faqs: [
        { q: "¿La TCC-I es un tipo de medicación?", a: "No. La TCC-I es un programa conductual y cognitivo. Usa técnicas estructuradas, no fármacos, para atender las causas del insomnio." },
        { q: "¿Cuánto tarda en funcionar?", a: "La mayoría nota algún cambio en 1–2 semanas y mejoras significativas en 4–8 semanas con práctica constante." },
        { q: "¿Es mejor que los somníferos?", a: "Para el insomnio crónico, sí — en el seguimiento a largo plazo. Las pastillas ayudan a corto plazo, pero los beneficios rara vez persisten al dejarlas." },
        { q: "¿Necesito un terapeuta?", a: "Un clínico entrenado da los mejores resultados, pero los programas digitales y autoguiados también tienen base científica y son eficaces." },
        { q: "¿Funciona si llevo años con insomnio?", a: "Sí. Aborda los patrones que mantienen el insomnio ahora, no solo el desencadenante original." },
        { q: "¿Tiene efectos secundarios?", a: "El principal 'efecto' es cansancio temporal durante la restricción del sueño en las primeras 1–2 semanas. No hay riesgos farmacológicos." },
        { q: "¿Puedo hacer TCC-I mientras tomo medicación?", a: "Sí, con guía clínica. Muchas personas reducen la medicación durante o tras la TCC-I." },
      ],
      nextLesson: "stimulus-control",
    },
    "90-minute-sleep-cycle": {
      meta: { title: "El ciclo de sueño de 90 minutos | Somna", desc: "Entiende cómo funcionan los ciclos de sueño y por qué despertar en el momento adecuado puede mejorar cómo te sientes." },
      eyebrow: "MICROLECCIÓN",
      title: "El ciclo de sueño de 90 minutos",
      subtitle: "El sueño no ocurre en un único bloque — se mueve por ciclos repetidos que moldean cómo te sentirás por la mañana.",
      readingTime: "5",
      keyTakeaways: [
      ...
      sections: [
        { heading: "¿Qué pasa mientras duermes?", paras: [
        ...
        { heading: "Las cuatro etapas del sueño", paras: [
        ...
        { heading: "Por qué importan los 90 minutos", paras: [
        ...
        { heading: "Por qué a veces te sientes pesado", paras: [
        ...
        { heading: "Cómo usan los ciclos las calculadoras", paras: [
      ...
      scienceNote: "La duración de los ciclos es un promedio — los reales varían entre 70 y 120 minutos y cambian a lo largo de la noche y entre personas.",
      practicalTip: "Apunta a 5 o 6 ciclos completos cuando puedas. Para la mayoría de adultos son 7,5–9 horas, justo dentro del rango recomendado.",
      cta: { label: "Usa la calculadora de ciclos", to: "/calculator" },
      relatedGuide: { slug: "how-to-fall-asleep-fast" },
      relatedTool: { to: "/calculator", label: "Calculadora de ciclos", desc: "Planifica la hora de dormir por ciclos completos." },
      faqs: [
        { q: "¿Cada ciclo dura exactamente 90 minutos?", a: "No — 90 minutos es un promedio. Los ciclos varían entre 70 y 120 minutos y cambian a lo largo de la noche y entre personas." },
        { q: "¿Cuántos ciclos debo intentar?", a: "La mayoría de adultos se siente mejor con 5–6 ciclos por noche, unas 7,5–9 horas." },
        { q: "¿Por qué a veces despierto pesado aun con horas suficientes?", a: "Probablemente despertaste en sueño profundo. Ajustar la hora de dormir 15–30 minutos suele ayudar." },
        { q: "¿Es el sueño profundo más importante que el REM?", a: "Ambos importan. El profundo apoya la recuperación física; el REM, la memoria y las emociones." },
        { q: "¿Puedo medir mis ciclos?", a: "Los wearables estiman etapas pero no son médicamente precisos. Las tendencias a lo largo de semanas son más útiles." },
        { q: "¿Por qué los ciclos cambian durante la noche?", a: "Los primeros ciclos contienen más sueño profundo; los últimos, más REM. Ambas mitades son importantes." },
        { q: "¿Las siestas también usan ciclos?", a: "Sí. Una siesta de 90 minutos puede incluir un ciclo completo; una de 20 minutos se queda en etapas ligeras y evita la pesadez." },
      ],
      nextLesson: "4-7-8-breathing",
    },
    "4-7-8-breathing": {
      meta: { title: "La respiración 4-7-8, explicada | Somna", desc: "Aprende cómo el método de respiración 4-7-8 puede reducir la activación fisiológica antes de dormir." },
      eyebrow: "MICROLECCIÓN",
      title: "La respiración 4-7-8, explicada",
      subtitle: "Un patrón de respiración simple que baja suavemente la activación fisiológica — un ritual previo al sueño con base fisiológica.",
      readingTime: "5",
      keyTakeaways: [
      ...
      sections: [
        { heading: "¿Qué es la respiración 4-7-8?", paras: [
        ...
        { heading: "Cómo practicarla", paras: [
        ...
        { heading: "Por qué puede sentirse calmante", paras: [
        ...
        { heading: "Cómo integrarla en tu rutina", paras: [
      ...
      scienceNote: "La respiración pautada y lenta ha mostrado reducir la frecuencia cardíaca, la presión arterial y el estrés autoinformado en adultos sanos.",
      practicalTip: "Esta noche, antes de apagar la luz, intenta 2–4 ciclos de 4-7-8. No persigues el sueño — señalas seguridad.",
      cta: { label: "Cómo dormirte rápido", to: "/how-to-fall-asleep-fast" },
      relatedGuide: { slug: "how-to-fall-asleep-fast" },
      relatedTool: { to: "/relax", label: "Sesión 4-7-8 guiada", desc: "Practica con una guía visual tranquila." },
      faqs: [
        { q: "¿La 4-7-8 te duerme directamente?", a: "No directamente. Reduce la activación y apoya el sueño, pero no es un sedante." },
        { q: "¿Cuántos ciclos debo hacer?", a: "Empieza con 4. Algunos practicantes aumentan con el tiempo. Más no siempre es mejor." },
        { q: "¿Es segura para todos?", a: "Suele serlo para adultos sanos. Con problemas pulmonares, presión baja o mareo, mejor respirar de forma natural." },
        { q: "¿Pueden practicarla los niños?", a: "Una versión más corta funciona para niños mayores, pero consulta al pediatra." },
        { q: "¿Por qué exhalar más largo?", a: "Las exhalaciones largas activan la rama parasimpática 'descansa y digiere'." },
        { q: "¿Y si contar me pone más ansioso?", a: "Salta el conteo. Respira lento por la nariz con una exhalación larga y suave." },
        { q: "¿Con qué frecuencia practicar?", a: "Lo ideal es a diario — incluso fuera de la hora de dormir — para entrenar la respuesta." },
      ],
      nextLesson: "racing-thoughts-at-night",
    },
    "racing-thoughts-at-night": {
      meta: { title: "Cuando la mente no se calma | Somna", desc: "Entiende por qué los pensamientos se hacen más ruidosos de noche y cómo la TCC-I aborda los pensamientos acelerados." },
      eyebrow: "MICROLECCIÓN",
      title: "Cuando la mente no se calma",
      subtitle: "Los pensamientos acelerados no son un defecto — son una respuesta predecible de un sistema nervioso activado. La TCC-I tiene herramientas concretas.",
      readingTime: "5",
      keyTakeaways: [
      ...
      sections: [
        { heading: "Por qué los pensamientos suenan más fuerte", paras: [
        ...
        { heading: "El modelo de hiperactivación", paras: [
        ...
        { heading: "Por qué intentar no pensar no funciona", paras: [
        ...
        { heading: "Estrategias útiles de TCC-I", paras: [
        ...
        { heading: "Cuándo buscar ayuda profesional", paras: [
      ...
      scienceNote: "El insomnio se entiende cada vez más como un trastorno de hiperactivación — tanto cognitiva (mental) como fisiológica (corporal).",
      practicalTip: "Esta noche, escribe la lista de tareas de mañana antes de lavarte los dientes. Externalizar la carga le dice al cerebro que no debe ensayarla en la cama.",
      cta: { label: "Lee la guía de ansiedad de sueño", to: "/sleep-anxiety" },
      relatedGuide: { slug: "sleep-anxiety" },
      relatedTool: { to: "/relax", label: "Respiración de cierre", desc: "Calma el cuerpo para calmar la mente." },
      faqs: [
        { q: "¿Por qué los pensamientos acelerados aparecen a la hora de dormir?", a: "Sin distracciones diurnas, los pensamientos internos no tienen con qué competir. Una corteza prefrontal cansada también amplifica la sensación de urgencia." },
        { q: "¿Debo intentar apartar los pensamientos?", a: "No — suele amplificarlos. La meta es notarlos y dejarlos pasar, como nubes en el cielo." },
        { q: "¿Sirve escribir?", a: "Sí, sobre todo al anochecer. Una 'ventana de preocupación' externaliza inquietudes para que no aparezcan en la cama." },
        { q: "¿Pensamientos acelerados es lo mismo que ansiedad?", a: "Se superponen mucho. Si vienen con preocupación persistente, bajo ánimo o pánico, considera hablar con un clínico." },
        { q: "¿Ayuda la meditación?", a: "Para muchas personas, sí — especialmente las prácticas de mindfulness que enseñan a observar sin engancharse." },
        { q: "¿Y escuchar un pódcast en la cama?", a: "Evidencia mixta. Audio ligero ayuda a algunas personas; contenido atractivo mantiene al cerebro activo." },
        { q: "¿Los pensamientos acelerados son sinónimo de insomnio?", a: "No por sí solos. El insomnio se define por dificultades de sueño al menos 3 noches por semana durante 3+ meses, con impacto diurno." },
      ],
      nextLesson: "circadian-rhythm",
    },
    "circadian-rhythm": {
      meta: { title: "Luz, cafeína y tu reloj interno | Somna", desc: "Aprende cómo la exposición a la luz y la cafeína afectan el ritmo circadiano y la hora de dormir." },
      eyebrow: "MICROLECCIÓN",
      title: "Luz, cafeína y tu reloj interno",
      subtitle: "Tu cuerpo tiene un reloj interno de 24 horas. La luz y la cafeína son dos de las señales más fuertes que moldean cuándo te llega el sueño.",
      readingTime: "5",
      keyTakeaways: [
      ...
      sections: [
        { heading: "¿Qué es el ritmo circadiano?", paras: [
        ...
        { heading: "Luz matinal y horario de sueño", paras: [
        ...
        { heading: "Exposición a luz nocturna", paras: [
        ...
        { heading: "Cómo afecta la cafeína", paras: [
        ...
        { heading: "Construir mejores hábitos de horarios", paras: [
      ...
      scienceNote: "La luz es una de las señales más potentes que moldean el reloj circadiano — sobre todo luz brillante de mañana y luz tenue de noche.",
      practicalTip: "Recibe luz exterior en la primera hora tras despertar — incluso un paseo de 5–10 minutos cuenta. Prueba dos semanas sin cafeína después de las 14 y observa tus noches.",
      cta: { label: "Usa la calculadora de hora de dormir", to: "/bedtime-calculator" },
      relatedGuide: { slug: "how-to-fall-asleep-fast" },
      relatedTool: { to: "/bedtime-calculator", label: "Calculadora de hora de dormir", desc: "Encuentra la mejor hora para acostarte." },
      faqs: [
        { q: "¿Cuánto dura la cafeína en el organismo?", a: "Vida media de unas 5 horas: la mitad de un café de las 14 sigue activa a las 19 y un cuarto a medianoche." },
        { q: "¿De verdad importa la luz matinal?", a: "Sí — es una de las señales más fuertes para anclar el ritmo circadiano. Incluso 5–10 minutos al aire libre ayudan." },
        { q: "¿Valen las gafas anti-luz azul?", a: "Bajar la intensidad general de luz por la noche suele importar más que filtrar específicamente el azul." },
        { q: "¿El descafeinado no tiene cafeína?", a: "No del todo — suele contener 2–15 mg por taza." },
        { q: "¿Y si trabajo de noche?", a: "Apunta a luz brillante en tu 'día' y oscuridad en tu 'noche'. Los turnos rotativos alteran el ritmo y requieren un plan a medida." },
        { q: "¿El alcohol afecta el reloj?", a: "El alcohol fragmenta el sueño aun cuando te ayude a dormir más rápido." },
        { q: "¿Qué tan rápido puedo reajustar mi ritmo?", a: "La mayoría de adultos se desplaza alrededor de 1 hora por día con señales constantes." },
      ],
      nextLesson: "stimulus-control",
    },
    "stimulus-control": {
      meta: { title: "Control de estímulos en palabras sencillas | Somna", desc: "Aprende una de las estrategias más eficaces de TCC-I para reconstruir la conexión saludable entre cama y sueño." },
      eyebrow: "MICROLECCIÓN",
      title: "Control de estímulos en palabras sencillas",
      subtitle: "El control de estímulos reentrena la simple asociación aprendida entre cama y sueño — y es una de las herramientas más poderosas de la TCC-I.",
      readingTime: "5",
      keyTakeaways: [
      ...
      sections: [
        { heading: "¿Qué es el control de estímulos?", paras: [
        ...
        { heading: "Cómo cambia el insomnio la asociación con la cama", paras: [
        ...
        { heading: "La regla de los 20 minutos", paras: [
        ...
        { heading: "Resultados que puedes esperar", paras: [
      ...
      scienceNote: "El control de estímulos es de las técnicas de TCC-I más estudiadas y se recomienda como tratamiento basado en evidencia por sí mismo para el insomnio crónico.",
      practicalTip: "Esta noche, saca pantallas, materiales de trabajo y portátil del dormitorio. Incluso un cambio físico pequeño reescribe la señal.",
      cta: { label: "Lee la guía completa de TCC-I", to: "/cbt-i-guide" },
      relatedGuide: { slug: "cbt-i-guide" },
      relatedTool: { to: "/calculator", label: "Calculadora de ciclos", desc: "Ajusta la hora de dormir a los ciclos naturales." },
      faqs: [
        { q: "¿Qué es el control de estímulos en TCC-I?", a: "Es usar la cama solo para dormir, dejarla si no estás durmiendo y mantener una hora fija de despertar — para que la cama vuelva a ser señal de sueño." },
        { q: "¿Cuánto tarda en funcionar?", a: "Muchas personas notan mejora en 1–3 semanas de práctica constante." },
        { q: "¿La regla de los 20 minutos es estricta?", a: "Es una guía. No mires el reloj — estima. Si estás claramente despierto y frustrado, sal de la cama." },
        { q: "¿Qué hago cuando salgo de la cama?", a: "Algo calmado y con luz tenue: leer un libro suave, estiramientos lentos, sentarte en silencio. Evita pantallas, trabajo y estímulos." },
        { q: "¿Sirve para los despertares de madrugada?", a: "Sí — aplica la misma regla. Si te despiertas y no vuelves a dormir, sal de la cama y regresa solo con sueño." },
        { q: "¿Y si salir me despierta más?", a: "Mantén luces tenues, actividad suave y cuerpo relajado. La meta no es estar plenamente despierto, sino dejar que el sueño regrese." },
        { q: "¿Puedo hacer control de estímulos solo?", a: "Puede ser eficaz por sí solo, pero combinado con restricción del sueño y horarios fijos produce los mejores resultados." },
      ],
      nextLesson: "what-is-cbti",
    },
  },
...
const dicts: Record<Lang, LearnDict> = { en, zh, es };
