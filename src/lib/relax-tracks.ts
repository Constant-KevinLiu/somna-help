...
export const relaxTracks: RelaxTrack[] = [
  {
    ...
    category: "guided",
    duration: "8 min",
    title: { en: "Body Scan", zh: "身体扫描", es: "Escaneo corporal" },
    description: {
  ...
  },
  {
    ...
    category: "guided",
    duration: "10 min",
    title: { en: "Letting Go of the Day", zh: "放下白天", es: "Soltar el día" },
    description: {
  ...
  },
  {
    ...
    category: "nature",
    duration: "30 min",
    title: { en: "Rain on Leaves", zh: "雨打树叶", es: "Lluvia sobre las hojas" },
    description: {
  ...
  },
  {
    ...
    category: "nature",
    duration: "45 min",
    title: { en: "Soft Ocean", zh: "海浪轻拍", es: "Océano suave" },
    description: {
  ...
  },
  {
    ...
    category: "guided",
    duration: "12 min",
    title: { en: "Anxiety Relief", zh: "缓解焦虑", es: "Alivio de la ansiedad" },
    description: {
  ...
  },
  {
    ...
    category: "noise",
    duration: "Loop",
    title: { en: "Pink Noise", zh: "粉红噪音", es: "Ruido rosa" },
    description: {
